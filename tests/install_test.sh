...
Successfully installed package 'test'.
Installing package 'brew'...
Successfully installed package 'brew'.
Installing package 'brew_packages'...
Successfully installed package 'brew_packages'.
EOF
    )
    [expected_status]=0
); run_test t
