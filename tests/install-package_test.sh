...
#     [test]="bin/df install-package pkNoNo -s"
#     [expected_output]=""
#     [expected_status]=1
# ); run_test t
...
#     [test]="bin/df install-package pkCD1 -s"
#     [expected_output]=""
#     [expected_status]=1
# ); run_test t
...
#     [test]="bin/df install-package pk_no_os"
...
#     [test]="bin/df install-package pk_no_os -s"
#     [expected_output]=""
#     [expected_status]=1
# ); run_test t
# declare -A t=(
#     [description]="Throw if the 'check' entry is not defined in 'packages.yaml'"
#     [test]="bin/df install-package pk_no_check"
...
#     [test]="bin/df install-package pk_no_check -s"
#     [expected_output]=""
#     [expected_status]=1
# ); run_test t
...
#     [test]="bin/df install-package pk_no_install"
...
#     [test]="bin/df install-package pk_no_install -s"
#     [expected_output]=""
#     [expected_status]=1
# ); run_test t
...
#     [test]="bin/df install-package pk_install_fail"
...
#     [test]="bin/df install-package pk_install_fail -s"
#     [expected_output]=""
#     [expected_status]=1
# ); run_test t
...
#     [test]="bin/df install-package pk3"
...
#     [test]="bin/df install-package pk3 -s"
#     [after_test]="rm /tmp/pk3.tmp || true"
#     [expected_output]=""
#     [expected_status]=0
# ); run_test t
